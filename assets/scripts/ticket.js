...
function newTicket(){
    ...
    option.value ='IT';
    option2.value = 'Facilities';
    option3.value = 'Lab Ops/Cloud Ops';
    option4.value = 'RES Tools';
    option.innerHTML = 'IT';
    option2.innerHTML = 'Facilities';
    option3.innerHTML = 'Lab Ops/Cloud Ops';
    option4.innerHTML = 'RES';
